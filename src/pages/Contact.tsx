          ...
          <div className="space-y-8">
            <div className="flex items-start gap-6 group">
              ...
              <div>
                ...
                <p className="text-gray-600 text-lg">Maharishi Prajapati Shiksha Samiti,<br/>Sukhertaal, Dist. Muzaffarnagar,<br/>Uttar Pradesh - 251309</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 group">
              <div className="w-16 h-16 bg-royal-50 rounded-3xl flex items-center justify-center text-royal-600 shrink-0 group-hover:bg-royal-600 group-hover:text-white transition-all">
                <Mail size={28} />
              </div>
              <div>
          ...
          <form className="space-y-8">
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input type="text" className="w-full px-6 py-4 border-2 border-slate-100 bg-slate-50 rounded-2xl focus:border-saffron-500 outline-none transition-all" placeholder="John" />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-black uppercase tracking-widest text-gray-500 ml-1">Last Name</label>
                <input type="text" className="w-full px-6 py-4 border-2 border-slate-100 bg-slate-50 rounded-2xl focus:border-saffron-500 outline-none transition-all" placeholder="Doe" />
              </div>
            </div>
            <div className="space-y-2">
              <label className="text-xs font-black uppercase tracking-widest text-gray-500 ml-1">Email Address</label>
              <input type="email" className="w-full px-6 py-4 border-2 border-slate-100 bg-slate-50 rounded-2xl focus:border-saffron-500 outline-none transition-all" placeholder="john@example.com" />
            </div>
            <div className="space-y-2">
              <label className="text-xs font-black uppercase tracking-widest text-gray-500 ml-1">Your Message</label>
              <textarea rows={5} className="w-full px-6 py-4 border-2 border-slate-100 bg-slate-50 rounded-2xl focus:border-saffron-500 outline-none transition-all" placeholder="How can we help you?"></textarea>
            </div>
            <button type="submit" className="w-full bg-gray-900 text-white py-5 rounded-2xl font-black text-lg hover:bg-saffron-600 transition-all shadow-xl active:scale-95 uppercase tracking-widest">
              Send Message
            </button>
          </form>
        </div>
