    ...
    <Section title="Our Legacy" subtitle="History & Vision" className="pt-8">
      <div className="max-w-4xl mx-auto">
        <div className="prose prose-lg text-gray-600 mx-auto leading-relaxed">
          <p className="mb-6">
            <strong>महार्षि प्रजापति शिक्षा समिति</strong> की स्थापना वर्ष 1989 में शुक्रतीर्थ, जनपद मुजफ्फरनगर (उत्तर प्रदेश) में कुछ दूरदर्शी एवं समाजसेवी व्यक्तियों द्वारा की गई थी। उस समय ग्रामीण क्षेत्र में शिक्षा के सीमित संसाधनों और विद्यार्थियों को हो रही कठिनाइयों को देखते हुए इन समाजसेवियों ने शिक्षा को समाज सुधार का माध्यम बनाने का संकल्प लिया।
          </p>
          <p className="mb-6">
