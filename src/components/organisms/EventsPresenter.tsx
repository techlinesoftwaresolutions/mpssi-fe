...
/**
 * EventsPresenter - Pure UI Component
 * Displays events from constants with no state management
 */
export const EventsPresenter: React.FC = () => {
  return (
          ...
          {EVENTS.map((event, index) => (
            ...
            >
              ...
              <div className="w-full lg:w-2/5">
                <span className="text-saffron-600 font-black text-xs tracking-[0.3em] uppercase mb-4 block">
                  {event.category}
                </span>
